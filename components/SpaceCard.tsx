...
export function SpaceCard({ space, handleDelete }: SpaceCardProps) {
        ...
        >
            <Card className="w-full max-w-3xl overflow-hidden rounded-2xl border border-gray-700 bg-gray-800 transition-all duration-300 ease-in-out hover:shadow-[0_10px_20px_rgba(128,90,213,0.5)]">
                <CardContent className="p-0">
                    <motion.div className="relative h-48 w-full sm:h-64 md:h-72 lg:h-80 xl:h-96" whileHover={{ scale: 1.04 }} transition={{ duration: 0.4 }}>
                        <Image src={
                        ...
                        <motion.div
                            className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-6"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
